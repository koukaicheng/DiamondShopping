          ...
          <div class="good-content">
            <div class="goods-info border-1px">
              ...
              <div class="bottom">
                ...
                <div class="collection-num" @click="favorate">
                  <!--<icon font-name="icon-shoucang" size="40" :color="favorateColor"></icon>-->
            ...
            <div class="tbody">
              <div class="status border-1px" @click="boxStatus">
                <icon font-name="icon-jiantou-copy" size="50"></icon>
              </div>
            ...
            <div class="title-heade">
              ...
              <div class="right" @click="certificateQuery(affiliated.report_no)">
                ...
                <div class="icon">
                  <icon font-name="icon-fanhui" size="30" color="#999999"></icon>
                </div>
              </div>
            </div>
            <div class="back"></div>
            <div class="goods-money">
              ...
              <div class="silder-box">
                <vue-slider @callback="silderChange" :pice=false v-bind="opciton" v-model="opciton.value"></vue-slider>
              </div>
              <div class="tip">
                估价结果包含交易产生的税费
              </div>
